...
☑️ PAANO PUMILI:
  ...
  3. ☑️ I-check ang lahat ng gusto mong gamitin — walang limitasyon!
     • Halimbawa: ☑️ Clean Voice + ☑️ Hall Reverb + ☑️ Blues Warm
...
🔊 BAKIT NAPAKABILIS AT WALANG ANTALA ANG TUNOG?
  ...
  ✅ < 10ms LATENCY — HALOS HINDI MARIRINIG ANG ANTALA!
  ...
  ✅ ZERO-LATENCY MODE — KAPAG KAILANGAN NG PINAKAMABILIS!
     ...
     • ⚠️ Tandaan: sa ibang lumang telepono — maaaring maging maingay
       kung masyadong mababa ang buffer — i-adjust sa Settings

📊 PAGKAKAIBA SA IBA PANG APP:

  ┌──────────────────────────┬──────────────────┬─────────────────────┐
  │                          │ IBANG APP        │ MARTODOSKO AUDIO    │
  ├──────────────────────────┼──────────────────┼─────────────────────┤
  │ Wika ng Pagproseso       │ Kotlin / Java    │ C++ NATIVE          │
  │ Bilis ng Pagproseso      │ Mabagal          │ PINAKAMABILIS       │
  │ Antala (Latency)         │ 50–200ms         │ < 10ms — HALOS WALA!│
  │ Daanan ng Signal         │ Dumadaan sa OS   │ DIREKTA SA HARDWARE │
...
❓ Bakit hindi lumalabas ang na-save kong preset?
  ✅ Pumunta sa Presets — hanapin sa listahan — ☑️ i-check — pindot APPLY.
